...
#| out-width: 100%
#| fig-cap: |
#|   Time series of peak bloom of cherry trees since 1880 at the four different sites.
cherry %>% 
  filter(year >= 1880) %>%
...
#| out-width: 100%
#| fig-cap: |
#|   Predictions and 90% prediction intervals from simple linear regression models fitted to all
#|   four sites.
