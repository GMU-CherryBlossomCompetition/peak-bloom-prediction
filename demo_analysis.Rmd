...
At the end of this document ([Appendix A](#appendix-rnoaa)), we also demonstrate a simple way to get historic temperature data for the four locations via the `rnoaa` package.
