...
In this analysis we demonstrate a very simple way of predicting the peak bloom date over the next decade for all four locations required by the competition.
The models are very simple and only use the past bloom dates observed at each location---no other covariates or additional information is considered.
