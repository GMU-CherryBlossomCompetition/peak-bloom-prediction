...
The models are simple in that they only use the past bloom dates observed at each location---no other covariates or additional information is considered.
